...
class InternalStateChange : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Column {
                Text(text = "Color of the box is changed when box is clicked")
                ColorBox(
...
fun ColorBox(modifier: Modifier = Modifier){
    ...
    Box(modifier = modifier
        .background(color.value)    //'color.value' refers to the 'color' declared above
